...
import type { InvoiceDetail, InvoiceSummary } from './platformApi';
...
/** Own-company enterprise subscription summary. Session-scoped; never a client companyId. */
export async function getCompanySubscription(): Promise<CustomerSubscriptionSummary> {
  return apiRequest<CustomerSubscriptionSummary>('/company/subscription');
}

/** Own-company invoices. Session-scoped; never a client companyId. */
